...
const MovieCardSkeleton = () => {
  return (
    <Card className="overflow-hidden shadow-none relative border-none hover:border rounded-3xl bg-inherit cursor-pointer hover:scale-[1.02] transition-transform duration-300 w-full md:w-80">
      <div className="flex items-center justify-between absolute top-2 w-full p-1 px-3">
        <span>
